...
blender --background "$ROOT/privacy_apartments.blend" \
  ...
  --python-expr "import bpy, os; bpy.ops.export_scene.gltf(filepath=os.path.join(os.environ['REBUILD_ROOT'], 'privacy_apartments.glb'), export_format='GLB', export_extras=True, export_lights=True)"
